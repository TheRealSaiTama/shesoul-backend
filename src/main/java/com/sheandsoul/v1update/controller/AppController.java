...
public class AppController {
    ...
    public AppController(AppService appService, MenstruationAssistantService menstruationAssistantService, MyUserDetailService userDetailsService, JwtUtil jwtUtil, OtpGenerationService otpGenerationService) {
