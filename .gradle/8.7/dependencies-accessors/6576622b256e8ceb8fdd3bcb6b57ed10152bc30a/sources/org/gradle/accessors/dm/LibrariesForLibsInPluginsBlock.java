...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        private final ComposeRuntimeVersionAccessors vaccForComposeRuntimeVersionAccessors = new ComposeRuntimeVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.compose.runtime</b>
         */
        public ComposeRuntimeVersionAccessors getRuntime() {
            return vaccForComposeRuntimeVersionAccessors;
        }

    }

    public static class ComposeRuntimeVersionAccessors extends VersionFactory  {

        public ComposeRuntimeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>compose.runtime.livedata</b> with value <b>1.6.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLivedata() { return getVersion("compose.runtime.livedata"); }
